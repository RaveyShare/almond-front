          ...
          <Card className="border-white/10 bg-white/5 backdrop-blur-sm">
            <CardContent className="p-8 space-y-8">
              ...
              <section>
                ...
                <div className="space-y-3 text-white/90">
                  <p>2.1 小杏仁服务的具体内容由我们根据实际情况提供，主要包括但不限于AI记忆辅助工具生成、思维导图制作、记忆口诀创建、感官联想训练、间隔重复学习等。</p>
              ...
              <section>
                ...
                <div className="space-y-3 text-white/90">
                  <p>3.1 用户在注册账号或使用小杏仁服务的过程中，需要提供一些必要的信息。如国家法律法规规定的其他信息，用户应当予以提供。</p>
              ...
              <section>
                ...
                <div className="space-y-3 text-white/90">
                  <p>4.1 用户不得利用小杏仁服务制作、上传、复制、发布、传播或者转载如下内容：</p>
                  ...
                  <p>4.2 用户不得通过任何手段滥用小杏仁服务，包括但不限于以下行为：</p>
                  <ul className="list-disc list-inside ml-4 space-y-2">
                  ...
                  <p>4.3 用户不得恶意注册或使用小杏仁账号，包括但不限于以任何方式盗用、占用、购买、出售账号。用户亦不得盗取他人账号、密码。</p>
                  <p>4.4 用户不得利用小杏仁服务生成的AI内容从事以下行为：</p>
                  <ul className="list-disc list-inside ml-4 space-y-2">
              ...
              <section>
                ...
                <div className="space-y-3 text-white/90">
                  <p>5.1 用户理解并同意，一旦购买了小杏仁服务的付费服务，包括但不限于预充值、订阅等形式，相关费用将不予退还。</p>
              ...
              <section>
                ...
                <div className="space-y-3 text-white/90">
                  <p>8.1 用户明确同意其使用小杏仁服务所存在的风险将完全由其自己承担。</p>
              ...
              <section>
                ...
                <div className="space-y-3 text-white/90">
                  <p>9.1 我们有权随时修改本协议的任何条款，一旦本协议的内容发生变动，我们将会直接在小杏仁网站上公布修改之后的协议内容，该公布行为视为我们已经通知用户修改内容。</p>
                  <p>9.2 修改后的协议一经在小杏仁网站上公布后，立即自动生效。</p>
                  <p>9.3 如用户不同意相关变更，必须立即停止使用小杏仁服务。任何形式的使用行为将视为用户对修改后协议的接受。</p>
              ...
              <section>
                ...
                <div className="space-y-3 text-white/90">
                  <p>10.1 用户理解并同意，通过小杏仁服务生成的AI内容仅供参考，我们不对其准确性、完整性或可靠性作出任何明示或暗示的保证。</p>
                  <p>10.2 用户应当自行判断并承担使用AI生成内容的风险。我们不承担因用户依赖这些内容而导致的任何直接或间接损失。</p>
                  <p>10.3 我们保留在无需通知的情况下，修改、更新或改进AI生成内容的权利。</p>
                  <p>10.4 用户不得利用小杏仁服务中的AI生成内容进行违法活动，或侵犯他人的知识产权或其他合法权益。</p>
              ...
              <section>
                ...
                <div className="space-y-3 text-white/90">
                  <p>11.1 本协议构成您与我们之间关于小杏仁服务使用的完整协议，取代您和我们先前和同时就相同服务所达成的任何形式的协议。</p>
